...
* **Criador** - _Creator_: atribuição da responsabilidade de criação ao elemento de programação na qual agrega, contém, guarda instância de, faz uso de e possui dados para inicialização;
