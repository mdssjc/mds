...
* **Especialista na Informação** - _Information Expert_ \(_Expert_\): atribuição da responsabilidade \(saber e fazer\) ao elemento de programação com a informação.
  Problema: Qual é o princípio básico pela qual atribui responsabilidades aos elementos?
  Solução: Atribua a responsabilidade para o elemento que tem a informação necessária para cumpri-la.
