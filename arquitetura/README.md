...
* [**Cenário**](cenario.md): Descrevendo o problema.
* [**Análise**](analise.md): O que fazer para solucionar o problema?
* [**Projeto**](projeto.md): Como fazer para solucionar o problema?
...
O guia para etapas são através dos [**Princípios, Padrões e Práticas**](principios-padroes-praticas.md).
