...
* **Controladora** - _Controller_: reponsável por manipular eventos no sistema, quando centralizado é conhecido por Controlador de Fachada - _Front Controller_ e quando implementa aplicações é conhecido por Controlador de Caso de Uso ou de Sessão;
* Polymorphism
* Indirection
* Pure Fabrication
