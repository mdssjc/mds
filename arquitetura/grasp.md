...
* **Variações Protegidas** - _Protected Variations_: atribuição da responsabilidade de proteger o sistema_._ Outros nomes: Encapsulamento - _Encapsulation_, Ocultamento de Informação - _Information Hiding_ ou Princípio do Aberto-Fechado - _Open-Closed Principle_.
