...
* [**Princípio de Substituição de Liskov**](http://c2.com/cgi/wiki?LiskovSubstitutionPrinciple "Liskov Substitution Principle") - _Liskov Substitution Principle_ \(_LSP_\) por _Barbara Liskov_ em 1988: os tipos derivados devem ser substituídos por seus tipos base.
  ...
  Dois problemas comuns são: primeiro, qualquer modificação no tipo base afeta todos os tipos derivados; e segundo, os tipos derivados evoluem com proposta diferente do tipo base.
